...
const Header = () => {
  return (
    <div className='header mx-auto my-10 max-w-[1200px] md:h-[100vh]'>
      <Navbar></Navbar>
      <div>
        <div className='grid p-5 md:p-0 md:flex '>
          <div className='flex flex-col justify-end gap-8'>
            <div className=' grid font-bold text-4xl  md:text-6xl gap-5 items-baseline'>
              <span>Take Your </span>
              <span> <span className='text-green-600'>Dreams</span> To The</span>
              <span>Next Level!</span>
            </div>
            <div>
              <p className='text-slate-600 w-[80%] md:w-[500px] font-semibold'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Totam delectus excepturi ullam consectetur deserunt nulla sequi, a architecto, sunt quasi ut sit eaque.</p>
            </div>
            <div className='flex'>
              <input className='border w-[70%] md:w-[300px] h-10 px-4 rounded-s-md border-green-600' type="text" placeholder='Search for a course' />
          ...
          <div>
            <div className='flex'>
              <img src={graph} alt="" />
              <img className='w-[80%] md:h-[500px] relative  -left-[300px] md:left-[-500px]' src={girlwithlaptop} alt="" />
            </div>
            <div className='flex items-center w-fit bg-white rounded-md relative md:-right-[8rem] -top-16'>
